export default function RegisterLoading() {
  return (
    <div className="grid min-h-screen place-items-center px-6 py-8">
      <div className="w-full max-w-[460px] space-y-4 rounded-2xl border border-brand-border bg-brand-surface p-7 shadow-card">
        {/* Encabezado skeleton */}
        <div className="space-y-2">
          <div className="h-8 w-4/5 animate-pulse rounded-lg bg-brand-border" />
          <div className="h-4 w-full animate-pulse rounded-lg bg-brand-border" />
        </div>

        {/* Campo nombre de usuario skeleton */}
        <div className="space-y-1.5">
          <div className="h-4 w-36 animate-pulse rounded bg-brand-border" />
        ...
        {/* Campo confirmar contraseña skeleton */}
        <div className="space-y-1.5">
        ...
        {/* Enlace skeleton */}
        <div className="mx-auto h-4 w-44 animate-pulse rounded bg-brand-border" />
      </div>
    </div>
  );
}
