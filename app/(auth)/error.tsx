...
export default function AuthError({
  ...
  return (
    <div className="grid min-h-screen place-items-center px-6 py-8">
      <div className="w-full max-w-[420px] space-y-5 rounded-2xl border border-brand-border bg-brand-surface p-7 shadow-card text-center">
        <div
          aria-hidden="true"
        ...
        <button
          ...
          className="w-full rounded-xl bg-brand-accent px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-brand-accentHover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-accent focus-visible:ring-offset-2"
        >
          Intentar de nuevo
        </button>
      </div>
